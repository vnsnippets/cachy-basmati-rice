...
hl.bind(mainMod .. " + Tab", hl.dsp.exec_cmd(quickshell .. " ipc call cockpit run"))
...
-- Screenshot
hl.bind(mainMod .. " + SHIFT + S",  hl.dsp.exec_cmd("hyprshot -m region --freeze --raw | satty --filename -"), { locked = true })